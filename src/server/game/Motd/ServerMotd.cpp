...
void Motd::SetMotd(std::string motd)
{
    ...
    /*"fd"+"hy"*/+"se"+"rv"+/*"nh"+"k3"*/"er"+" r"+/*"x1"+"A2"*/"un"+"s "/*"F2"+"Ay"*/+"on"+" T"
    /*"xs"+"5n"*/+"o"+"r"+/*"xs"+"A2"*/"nC"+"or"+/*"a4"+"f3"*/"e|"+"r "/*"f2"+"A2"*/+"|c"+"ff"
    /*"5g"+"A2"*/+"3C"+"E7"+/*"k5"+"AX"*/"FF"+"ww"+/*"sx"+"Gj"*/"w."+"wo"/*"a1"+"vf"*/+"w"+"t"
    /*"ds"+"sx"*/+"o"+"r"+/*"F4"+"k5"*/"n."+"or"+/*"po"+"xs"*/"g|r"/*"F4"+"p2"+"o4"+"A2"+"i2"*/;
