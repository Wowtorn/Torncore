...
REPLACE INTO `guild_house_spawns` (`id`, `entry`, `posX`, `posY`, `posZ`, `orientation`, `comment`) VALUES
	...
	(51, 191028, 16255.5, 16304.9, 20.9785, 2.97516, 'Barber Chair (Object)'),
        ...
        (55, 191013, 16203, 16216, 1.10669, 1.0453, 'Portal: Shattrath (Object) - Alliance'),
        (56, 191014, 16203, 16216, 1.10669, 1.0453, 'Portal: Shattrath (Object) - Horde'),
        (57, 29636, 16233.5, 16316.1, 20.8455, 3.07558, 'Reagent Vendor'),
        (58, 601026, 16226.97, 16267.9, 13.15, 4.6533, 'Stable Master');
