...
public:
    ...
    bool OnGossipHello(Player *player, Creature * creature)
    {
        ...
        player->ADD_GOSSIP_ITEM_EXTENDED(GOSSIP_ICON_TALK, "Spawn Zomble", GOSSIP_SENDER_MAIN, 601035, "Spawn Zomble?", GuildHouseZomble, false);
	...
	case 29636: // Reagent Vendor
        ...
        // Zomble (requires gm island module)
        case 601035: //zomble gmisland
            cost= GuildHouseZomble;
            SpawnNPC(action, player);
            break;  
        //
        // Objects
